  ...
  },
  {
    ...
    icon: (
      <svg
        ...
        strokeLinecap="round"
        strokeLinejoin="round"
        className="icon icon-tabler icons-tabler-outline icon-tabler-file-cv text-white"
      >
        <path stroke="none" d="M0 0h24v24H0z" fill="none" />
  ...
  },
  {
    ...
    icon: (
      <svg
        ...
        strokeLinecap="round"
        strokeLinejoin="round"
        className="icon icon-tabler icons-tabler-outline icon-tabler-mail text-white"
      >
        <path stroke="none" d="M0 0h24v24H0z" fill="none" />
    ...
    href: "mailto:praneet2656@gmail.com",
  },
];
